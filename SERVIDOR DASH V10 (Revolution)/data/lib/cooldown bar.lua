...
for cds = 1, 12 do                                                        
    ...
    if getCD(a.uid, cdzin) > 0 then                                                      
       if useOTClient and b then 
          table.insert(ret, (getCD(a.uid, cdzin)).."|"..b.minLv.."|".. getLevel(summon)..",") 
       else 
          table.insert(ret, (getCD(a.uid, cdzin) -1)..",") 
       end   
    else
       if (useOTClient and b) then table.insert(ret, "0|"..b.minLv.."|".. getLevel(summon)..",") else table.insert(ret, "0,") end      
    end
end
doPlayerSendCancel(cid, table.concat(ret))                                            
end
