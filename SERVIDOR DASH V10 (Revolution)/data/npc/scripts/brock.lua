...
local pokemons = {
{name = "Geodude", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Rhydon", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "poke"},   --alterado v1.3
{name = "Machamp", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Onix", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Golem", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "poke"},
}
