...
local pokemons = {
{name = "Scizor", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Vileplume", optionalLevel = 450, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Exeggutor", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Meganium", optionalLevel = 450, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Venusaur", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Scyther", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
}
...
local function doWinDuel(cid, npc)
	...
	setPlayerStorageValue(cid, 996, 1)
end
...
function onCreatureSay(cid, type, msg)
	...
	if isDuelMsg(msg) and conv == 1 and focus == cid then
		...
		if getPlayerStorageValue(cid, 996) == 1 then
		    focus = 0
