local combat, areadano, effect, area, dir = {}, {}, {114, 114, 114, 114, 114, 114, 114, 114, 114, 114, 114, 114}, {
...
num4 = 255 --- last
	...
	doAreaCombatHealth(cid, POISONDAMAGE, getCreaturePosition(cid), areadano[i],  -((num1)+(level*(num3))), -((num2)+(level*(num3))), num4) 
	end
return true
end
