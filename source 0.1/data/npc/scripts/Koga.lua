...
selfSay("Welcome to the gym of Pewter City. My name is Koga and I am the leader of this gym. Would you like to battle me?")
...
doGymBattle("Koga", "Koga Nidoking", cid, 1)
setPlayerStorageValue(cid, ginasios["Koga"].storage, 1)
setPlayerStorageValue(cid, 998, 0)
    ...
    if getPlayerStorageValue(cid, 998) == -1 then
    focus = 0
    return true
    end
