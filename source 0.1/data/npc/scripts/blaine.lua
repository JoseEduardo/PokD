...
selfSay("Welcome to the gym of Pewter City. My name is Blaine and I am the leader of this gym. Would you like to battle me?")
...
doGymBattle("Blaine", "Blaine Charizard", cid, 1)
setPlayerStorageValue(cid, ginasios["Blaine"].storage, 1)
setPlayerStorageValue(cid, 995, 0)
    ...
    if getPlayerStorageValue(cid, 995) == -1 then
    focus = 0
    return true
    end
