...
selfSay("Welcome to the gym of Pewter City. My name is Sabrina and I am the leader of this gym. Would you like to battle me?")
...
doGymBattle("Sabrina", "Sabrina Gengar", cid, 1)
setPlayerStorageValue(cid, ginasios["Sabrina"].storage, 1)
setPlayerStorageValue(cid, 993, 0)
    ...
    if getPlayerStorageValue(cid, 993) == -1 then
    focus = 0
    return true
    end
