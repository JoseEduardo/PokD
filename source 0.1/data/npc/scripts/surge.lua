...
selfSay("Welcome to the gym of Pewter City. My name is Surge and I am the leader of this gym. Would you like to battle me?")
...
doGymBattle("Surge", "Surge Jolteon", cid, 1)
setPlayerStorageValue(cid, ginasios["Surge"].storage, 1)
setPlayerStorageValue(cid, 994, 0)
